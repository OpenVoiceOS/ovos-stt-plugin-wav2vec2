...
def get_version():
    ...
    version = None
    version_file = os.path.join(BASEDIR, 'ovos_stt_plugin_wav2vec', 'version.py')
...
PLUGIN_ENTRY_POINT = 'ovos-stt-plugin-wav2vec = ovos_stt_plugin_wav2vec:Wav2VecSTT'
...
setup(
    ...
    license='Apache-2.0',
    packages=['ovos_stt_plugin_wav2vec'],
